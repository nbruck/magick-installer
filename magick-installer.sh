...
download http://sourceforge.net/projects/wvware/files/libwmf/0.2.8.4/libwmf-0.2.8.4.tar.gz
...
download http://ghostscript.googlecode.com/files/ghostscript-fonts-std-8.11.tar.gz
